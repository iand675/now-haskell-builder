...
module AWSLambdaRuntime.Core where
...
-- | 
data AWSLambdaRuntimeConfig = AWSLambdaRuntimeConfig
...
-- | display the config
instance P.Show AWSLambdaRuntimeConfig where
  show c =
    T.printf
...
-- | constructs a default AWSLambdaRuntimeConfig
--
-- configHost:
--
-- @http://localhost/2018-06-01@
--
-- configUserAgent:
--
-- @"aws-lambda-runtime/0.1.0.0"@
--
newConfig :: IO AWSLambdaRuntimeConfig
newConfig = do
    logCxt <- initLogContext
    return $ AWSLambdaRuntimeConfig
        { configHost = "http://localhost/2018-06-01"
        , configUserAgent = "aws-lambda-runtime/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => AWSLambdaRuntimeConfig -> auth -> AWSLambdaRuntimeConfig
addAuthMethod config@AWSLambdaRuntimeConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: AWSLambdaRuntimeConfig -> IO AWSLambdaRuntimeConfig
...
withStderrLogging :: AWSLambdaRuntimeConfig -> IO AWSLambdaRuntimeConfig
...
withNoLogging :: AWSLambdaRuntimeConfig -> AWSLambdaRuntimeConfig
...
data AWSLambdaRuntimeRequest req contentType res accept = AWSLambdaRuntimeRequest
  { rMethod  :: NH.Method   -- ^ Method of AWSLambdaRuntimeRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of AWSLambdaRuntimeRequest
  , rParams   :: Params -- ^ params of AWSLambdaRuntimeRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (AWSLambdaRuntimeRequest req contentType res accept) NH.Method
rMethodL f AWSLambdaRuntimeRequest{..} = (\rMethod -> AWSLambdaRuntimeRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (AWSLambdaRuntimeRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f AWSLambdaRuntimeRequest{..} = (\rUrlPath -> AWSLambdaRuntimeRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (AWSLambdaRuntimeRequest req contentType res accept) Params
rParamsL f AWSLambdaRuntimeRequest{..} = (\rParams -> AWSLambdaRuntimeRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (AWSLambdaRuntimeRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f AWSLambdaRuntimeRequest{..} = (\rAuthTypes -> AWSLambdaRuntimeRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => AWSLambdaRuntimeRequest req contentType res accept -> param -> AWSLambdaRuntimeRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: AWSLambdaRuntimeRequest req contentType res accept -> param -> AWSLambdaRuntimeRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: AWSLambdaRuntimeRequest req contentType res accept -> param -> AWSLambdaRuntimeRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** AWSLambdaRuntimeRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> AWSLambdaRuntimeRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = AWSLambdaRuntimeRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: AWSLambdaRuntimeRequest req contentType res accept -> [NH.Header] -> AWSLambdaRuntimeRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: AWSLambdaRuntimeRequest req contentType res accept -> [NH.HeaderName] -> AWSLambdaRuntimeRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => AWSLambdaRuntimeRequest req contentType res accept -> AWSLambdaRuntimeRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => AWSLambdaRuntimeRequest req contentType res accept -> AWSLambdaRuntimeRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: AWSLambdaRuntimeRequest req contentType res accept -> [NH.QueryItem] -> AWSLambdaRuntimeRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: AWSLambdaRuntimeRequest req contentType res accept -> WH.Form -> AWSLambdaRuntimeRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: AWSLambdaRuntimeRequest req contentType res accept -> NH.Part -> AWSLambdaRuntimeRequest req contentType res accept
...
_setBodyBS :: AWSLambdaRuntimeRequest req contentType res accept -> B.ByteString -> AWSLambdaRuntimeRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: AWSLambdaRuntimeRequest req contentType res accept -> BL.ByteString -> AWSLambdaRuntimeRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => AWSLambdaRuntimeRequest req contentType res accept -> P.Proxy authMethod -> AWSLambdaRuntimeRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: AWSLambdaRuntimeConfig
    -> a
    -> AWSLambdaRuntimeRequest req contentType res accept
    -> IO (AWSLambdaRuntimeRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> AWSLambdaRuntimeConfig
  -> IO (AWSLambdaRuntimeRequest req contentType res accept)
_applyAuthMethods req config@(AWSLambdaRuntimeConfig {configAuthMethods = as}) =
  foldlM go req as
  where
