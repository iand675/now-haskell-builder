...
module AWSLambdaRuntime.Client where
...
dispatchLbs
  ...
  -> AWSLambdaRuntimeConfig -- ^ config
  -> AWSLambdaRuntimeRequest req contentType res accept -- ^ request
